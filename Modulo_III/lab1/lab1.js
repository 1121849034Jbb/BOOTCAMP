...
// Función ArrowFunction llamada iterateUsers
const iterateUsers = () => {
    // Iterar a través de los usuarios y mostrar los resultados en la consola
    users.forEach(user => {
        console.log(`(user id: ${user.user_id}, first_name: '${user.first_name}', last_name: '${user.last_name}', age: ${user.age}, email: '${user.email}')`);
    });
};

// Llamar a la función iterateUsers
iterateUsers();